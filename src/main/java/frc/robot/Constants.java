...
public final class Constants {
  ...
  public static class ElevatorConstants {
    ...
    public static final GenericEntry elevatorPositionM_entery = ELEVATOR_SHUFFLEBOARD_TAB
        .add("Elevator Position (m)", 0)
        .withPosition(0, 0)
        .withSize(2, 1)
        .getEntry();
    public static final GenericEntry elevatorPositionIN_entry = ELEVATOR_SHUFFLEBOARD_TAB
        .add("Elevator Position (in)", 0)
        .withPosition(0, 0)
        .withSize(2, 2)
        .getEntry();
    ...
    public static final ShuffleboardLayout ELEVATOR_PID_LAYOUT = ELEVATOR_SHUFFLEBOARD_TAB
        ...
        .withPosition(0, 2)
        .withSize(3, 2);
    public static final GenericEntry rotation_entry = ELEVATOR_SHUFFLEBOARD_TAB
        .add("Motor Rotations", 0)
        .withPosition(2, 1)
        .withSize(1, 1)
        .getEntry();
    ...
    public final static double gearRatio = 5;
    ...
    public final static double kG = 0.06; // Volts to hold position against gravity
    public final static double kV = 3.72 / 6000.0 * 60.0; // Volts per (rot/s) - based on free speed ~6000 RPM
    ...
    public final static double drumRadius = Units.inchesToMeters(0.944299); // 1 inch drum radius
